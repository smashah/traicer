...
- **Build pipeline:** TypeScript and Rust checks, package/integration/security tests, native daemon compilation, Tauri debug packaging, multi-platform tagged packaging, checksums, CycloneDX SBOMs, provenance, and draft releases.
