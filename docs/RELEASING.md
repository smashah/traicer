...
pnpm install
pnpm release:status
pnpm --filter @traice-market/traicer test
pnpm --filter @traice-market/traicer typecheck
pnpm --filter @traice-market/traicer build
